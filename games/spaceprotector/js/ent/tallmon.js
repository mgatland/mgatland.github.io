...
define(["sprites", "spritedata", "util", "ent/monster"], 
	...
	var sprites = Sprites.loadFramesFromData(SpriteData.walker);
	var anims = {
	...
	var TallMon = function (gs, x, y) {
		...
		Util.extend(this, new Monster(gs, x, y, 10, 9, sprites, anims, ai, initialHealth, onHit));
		this.pos.y -= 10;
